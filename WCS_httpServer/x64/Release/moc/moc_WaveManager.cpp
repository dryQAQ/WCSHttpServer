...
QT_MOC_LITERAL(9, 110, 9), // "waveBound"
QT_MOC_LITERAL(10, 120, 10), // "codeMarked"
QT_MOC_LITERAL(11, 131, 4), // "code"
QT_MOC_LITERAL(12, 136, 6) // "sorted"

    },
    "WaveManager\0waveReceived\0\0orderCode\0"
    "skuCount\0waveSortingStarted\0"
    "waveReadyToReport\0waveStatusChanged\0"
    "newStatus\0waveBound\0codeMarked\0code\0"
    "sorted"
};
...
void WaveManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->waveBound((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->codeMarked((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< bool(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            using _t = void (WaveManager::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&WaveManager::waveBound)) {
                *result = 4;
                return;
            }
        }
...
// SIGNAL 4
void WaveManager::waveBound(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
