...
void HttpClient::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 4: _t->onRfidBindingReplyFinished(); break;
        default: ;
        }
        ...
        {
            using _t = void (HttpClient::*)(const QMap<QString,QString> & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&HttpClient::rfidBindingResult)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void HttpClient::rfidBindingResult(const QMap<QString,QString> & _t1)
{
