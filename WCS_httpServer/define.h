...
// ═══════════════════════════════════════════════════════════════════════════
// ★ 2026-09-13 UI资源（借鉴 WCSApps 的自绘标题栏做法）
//   1 = 无边框窗口 + 顶部自绘标题栏（徽标/标题/环境标识 + 最小化/最大化/关闭按钮）；
//       拖动与边缘缩放走 Windows 原生 WM_NCHITTEST（HTCAPTION/HTLEFT…），语义与系统一致；
//       最大化时显式校正到"可用工作区"（避免个别系统连任务栏一起盖住）。
//   0 = 保留系统原生窗口边框（旧外观，一键回退用）
// ═══════════════════════════════════════════════════════════════════════════
#define WCS_FRAMELESS_TITLEBAR    1
